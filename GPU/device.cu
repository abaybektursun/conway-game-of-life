...
#define live_cells( thread_1D_pos, x, y, world ) (    (world[(thread_1D_pos-x-1)%(x*y)]/(world[(thread_1D_pos-x-1)%(x*y)]-1)) + (world[(thread_1D_pos-x)%(x*y)]/(world[(thread_1D_pos-x)%(x*y)]-1)) + (world[(thread_1D_pos-x+1)%(x*y)]/(world[(thread_1D_pos-x+1)%(x*y)]-1))     \
                                   +                  (world[(thread_1D_pos - 1)%(x*y)]/(world[(thread_1D_pos - 1)%(x*y)]-1)) +                                                                       (world[(thread_1D_pos-x+1)%(x*y)]/(world[(thread_1D_pos-x+1)%(x*y)]-1))     \
                                   +                  (world[(thread_1D_pos+x-1)%(x*y)]/(world[(thread_1D_pos+x-1)%(x*y)]-1)) + (world[(thread_1D_pos+x)%(x*y)]/(world[(thread_1D_pos+x)%(x*y)]-1)) + (world[(thread_1D_pos+x+1)%(x*y)]/(world[(thread_1D_pos+x+1)%(x*y)]-1))     )
